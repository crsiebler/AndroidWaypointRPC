...
public class JsonRpcRequestViaHttp {
    ...
    private String post(URL url, Map<String, String> headers, String data) throws Exception {
        ...
        Log.d(getClass().getSimpleName(), "ATTEMPTING: SERVER CONNECTION");
        ...
        try {
            ...
            Log.d(getClass().getSimpleName(), "ERROR: COULD NOT CONNECT (RESPONSE: " + connection.getResponseCode() + ")");
        }
        ...
        Log.d(getClass().getSimpleName(), "COMPLETE: SERVER CONNECTION");
